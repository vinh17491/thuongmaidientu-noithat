...
BEGIN TRY
    ...
    IF NOT EXISTS(SELECT 1 FROM sys.key_constraints WHERE name=N'PK_shipping_services') ALTER TABLE dbo.shipping_services ADD CONSTRAINT PK_shipping_services PRIMARY KEY(service_id);
