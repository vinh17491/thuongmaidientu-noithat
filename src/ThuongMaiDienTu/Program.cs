...
{
    // Keep the transport limit slightly above the 5 MB business limit so the
    // controller can return a friendly validation message instead of dropping
    // an oversized multipart request.
